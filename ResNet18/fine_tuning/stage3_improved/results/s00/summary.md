...
| game6 | 92 | 5888 | 0.8685 | 0.0000 | 0.6594 | 55.59/64 |
| **agg** | 169 | 10816 | **0.9085** | **0.0355** | **0.7556** | 58.14/64 |

**Verdict:** stage3_323 per-square acc on held-out (games 2/6) is **0.9085**. v1 zero-shot held-out aggregate not available on disk — compare via `zero_shot/results/games_2_4_5_6_eval/` if present, or re-evaluate the baseline checkpoint on this exact partition.
...
| held-out per-sq | 0.8582 | 0.9085 | +0.0502 |
| held-out piece-only | 0.5408 | 0.7556 | +0.2148 |
| forgetting Δ on 5% v1 | -0.0796 | -0.1295 | -0.0499 |

### Per-class on aggregate held-out (different test partition — caveat applies)

| class | stage2_30 (2/4/5/6) | stage3_323 (2/6) | Δ |
|-------|--------------------:|-----------------:|---:|
| wP | 0.8223 | 0.9662 | +0.1440 |
| wR | 0.5578 | 0.9762 | +0.4184 |
| wN | 0.0201 | 0.3491 | +0.3290 |
| wB | 0.5918 | 0.3333 | -0.2584 |
| wQ | 0.1797 | 0.1439 | -0.0358 |
| wK | 0.0866 | 0.4497 | +0.3631 |
...
- `checkpoints/best_synth_monitor.pt` (epoch 10, synth_monitor_acc=0.8875) — monitor-only
...
|--------|----------------:|------------------:|---:|
| per-sq acc | 0.8578 | 0.9085 | +0.0507 |
| piece-only | 0.6317 | 0.7556 | +0.1239 |
...
|-------|-----------------:|------------------:|---:|
| wP | 0.8684 | 0.9662 | +0.0978 |
| wR | 0.8143 | 0.9762 | +0.1619 |
| wN | 0.0237 | 0.3491 | +0.3254 |
| wB | 0.5172 | 0.3333 | -0.1839 |
| wQ | 0.1591 | 0.1439 | -0.0152 |
| wK | 0.1716 | 0.4497 | +0.2781 |
