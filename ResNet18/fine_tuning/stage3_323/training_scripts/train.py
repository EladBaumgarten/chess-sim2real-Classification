"""
Project 2 — Fine-tuning STAGE 3 (~323 real frames: 30 manual + game4 + game5 PGN).
...
# === Experiment dirs ===
EXP_DIR = f"{PROJECT_ROOT}/fine_tuning/stage3_323"
...
for epoch in range(1, NUM_EPOCHS + 1):
    ...
    train_loss, train_acc = train_one_epoch(
        model, train_loader, criterion, optimizer, DEVICE, print_every=100)
