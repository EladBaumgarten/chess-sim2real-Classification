...
CKPTS = {"combined_game6": f"{ROOT}/dino/checkpoints/dino_combindedGame6/best_real.pt",
         "label_smoothing": f"{ROOT}/dino/ablation_LabelSmoothing/checkpoints/best_real.pt"}
OUT = f"{ROOT}/dino/ablation_LabelSmoothing/results/labelsmooth_vs_combined_compare.json"
